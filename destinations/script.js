...
loginBtn.addEventListener("click", () => {
  window.location.href = `../authentification/index.php?link=${window.location.origin + window.location.pathname}`;
});
...
signupBtn.addEventListener("click", () => {
  window.location.href = `../authentification/index.php?register=true&link=${window.location.origin + window.location.pathname}`;
});
